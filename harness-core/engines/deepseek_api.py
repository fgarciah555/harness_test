...
Requiere DEEPSEEK_API_KEY en el entorno (o en un .env en la raíz del repo).
"""
import os
...
# engines/ vive en harness-core/engines/ -- el .env real vive en la raíz del
# repo (un nivel más arriba que harness-core/), no junto a harness-core/.
